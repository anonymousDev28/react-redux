...
function ListCourse() {
    const { data: listCourse, isLoading, isError, error } = useGetAllCourseQuery();
                ...
                <div className="container">
                    ...
                    <div className="course-list-inner p-2">
                        <table className="table course-table">
                            ...
                            <tbody>
                                {console.log(listCourse.totalItems)}
                                {console.log(listCourse.data)}
                                {listCourse.totalItems > 0 && listCourse.data.map((c, index) => (
                                    <tr key={c.id}>
                                        <td>{index+1}</td>
                                        <td>
